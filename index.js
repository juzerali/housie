...
async function showCreateWidget() {
    ...
    games.forEach(await async function (game, i) {
        ...
        let wrapper = wrapperFor(game);
        li.append(wrapper).appendTo($existingGamesList);
